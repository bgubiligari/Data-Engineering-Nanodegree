...
songplay_table_create = ("""CREATE TABLE IF NOT EXISTS songplays (start_time timestamp PRIMARY KEY, \
...
artist_id varchar NOT NULL, year int, duration decimal)""")
...
time_table_create = ("""CREATE TABLE IF NOT EXISTS time (start_time time with time zone PRIMARY KEY, hour int, \
...
location, user_agent) VALUES (%s, %s, %s, %s, %s, %s, %s, %s) ON CONFLICT (start_time) DO NOTHING""")
